...
- `natural-language-fuzzy-search-recommendation-design.md`：自然语言模糊搜索与 LLM 查询扩展设计，冻结 direct search gate、zero-result LLM routing、7 类语义分类、结构化 prompt、扩展查询、热门回退、敏感领域关键词搜索和审计诊断。
