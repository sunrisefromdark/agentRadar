...
| 02 | [证据轴与相关性门控](行业级Agent趋势判断设计/02-证据轴与相关性门控.md) | V1 十轴证据、Agent relevance gate、相关性 profile |
...
| 06 | [工具保障与 Seed Registry](行业级Agent趋势判断设计/06-工具保障与SeedRegistry.md) | 工具四级保障链路、工具 seed、V1 Seed Registry 完成基线 |
...
- 拆分只改变文档组织，不改变任何设计语义、V1 完成定义、评分规则、Agent 分工或治理要求。
