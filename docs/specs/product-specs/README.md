...
- `agent-trend-radar-product-spec.md`：趋势雷达的用户目标、场景矩阵和验收判断。
- `Agent引入与推荐增强需求分析.md`：冻结“Agent 增强而不替代规则主链路”的产品需求，覆盖解释、个性化、复核与周趋势抽象。
- `外部发现与补证信号层需求分析.md`：冻结“外部发现 + 外部补证”分层信号层的产品需求，明确其作为低于 GitHub / Trendshift 的次级判断信号参与 daily / weekly，用于更早发现候选并补充“谁在讨论、讨论是否持续、是否跨平台”的外部证据。
...
- `侧边助手自然语言搜索需求分析.md`：冻结“显式侧边助手入口 + 多轮会话记忆 + 3 条超链接结果预览 + 查看全部结果”的自然语言项目搜索需求。
...
- `trend-radar-ui-v3-stage-redesign-requirements.md`：冻结 UI-V3 的舞台化前端改版需求，明确全局声层、路由人格、设计系统、边界与验收标准。
